...
const Categories = ({ cart }) => {
  return (
    <aside
      className={`fixed top-0 left-0  z-40 w-18 overflow-auto lg:w-58 h-screen pt-8 pb-10 dark:bg-darkMenu transition-transform  shadow-lg md:translate-x-0  dark:border-x-grayTxt ${
