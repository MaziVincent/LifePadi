...
const Vendor = () => {
  ...
  return (
    <main className=" flex justify-center px-5">
      <div className=" w-full lg:w-11/12 xl:w-10/12  grid grid-cols-1 lg:grid-cols-5  lg:justify-around ">
        ...
        {/* <div className={` hidden ${cart && 'fixed flex '} w-full col-span-2   overflow-y-auto  lg:flex justify-center `}>
