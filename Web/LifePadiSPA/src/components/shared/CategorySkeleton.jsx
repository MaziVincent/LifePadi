const CategorySkeleton = () => {
  return (
      <div className=" flex flex-col animate-pulse min-w-32 bg-gray gap-5 justify-center items-center bg-opacity-20 py-4 rounded-lg shadow-md">
        <div className="flex items-center justify-center w-full h-10 bg-gray rounded sm:w-20 dark:bg-card">
          <svg
        ...
        <div className="h-3 bg-gray rounded-full dark:bg-card w-20 mb-4"></div>
      </div>
