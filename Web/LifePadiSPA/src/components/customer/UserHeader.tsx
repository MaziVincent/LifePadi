...
const UserHeader = ({ setAside }: UserHeaderProps) => {
	...
	return (
		<nav className=" px-4 py-2.5 bg-primary dark:bg-card fixed left-0 right-0 top-0 z-50 shadow-md ">
			...
			<div className="flex  justify-between items-center">
				<div className="flex justify-start items-center">
					...
					<Link to="/" className="flex items-center justify-between gap-5 mr-4">
