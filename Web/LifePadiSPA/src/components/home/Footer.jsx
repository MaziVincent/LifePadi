...
>>>>>>> 3f80dfc (latest commit)
            d="M0,192L60,192C120,192,240,192,360,202.7C480,213,600,235,720,213.3C840,192,960,128,1080,122.7C1200,117,1320,171,1380,197.3L1440,224L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"
          ></path>
        </svg>
      </div>
      <div className="mx-auto max-w-screen-xl px-5 pb-6">
