const Faq = () => {
  return (
    <section className="bg-primary dark:bg-background pt-20">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <h2 className="mb-8 text-4xl tracking-tight font-extrabold text-grayTxt dark:text-primary">
          Frequently asked questions
        </h2>
        <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
          <div>
            <div className="mb-10">
              <h3 className="flex items-center mb-4 text-lg font-medium text-grayTxt dark:text-primary">
                <svg
                  className="flex-shrink-0 mr-2 w-5 h-5 text-gray dark:text-graybg"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <p className="text-gray dark:text-graybg">
            ...
            <div className="mb-10">
              ...
              <p className="text-gray dark:text-graybg">
                ...
                <a
                  href="#"
                  className="font-medium underline text-primary dark:text-primary hover:no-underline"
                  target="_blank"
                  rel="noreferrer"
                >
                  contact us
