			...
			<div className=" flex flex-col gap-10 ">
					...
					<div className=" w-full ">
						...
						<div className="mt-6 flex flex-col justify-center items-center gap-8 w-full">
							<div>
								<Link
									to="/shop/logistics"
									className=" bg-secondary hover:bg-background rounded-xl p-3 text-accent font-semibold cursor-pointer"
								>
							...
							<div className="w-full flex justify-center gap-5">
								<a
									...
									className=" bg-primary py-3 px-2 rounded-lg flex items-center gap-2 max-md:rounded-full max-md:px-3"
								>
				...
				<div className=" bg-background w-full">
					...
					<div className=" flex justify-center items-center gap-2 mt-20">
						<a
							href="https://play.google.com/store/apps/details?id=com.lifepadi.app"
							className=" w-14 bg-primary p-4 flex items-center justify-center rounded-full"
						>
							<img
								src={Playstore}
								alt=""
					...
					<div className=" lg:flex justify-center ">
						<div className=" flex justify-between lg:w-10/12 items-center max-md:flex-col max-md:items-start max-md:gap-8 px-10 mt-20">
							...
							<p className=" text-3xl max-md:text-xl text-center font-semibold w-7/12 max-md:w-full text-primary">
								...
								easy deliveries. LifePadi is here!. Get started and experience
						...
						<div className=" bg-primary rounded-3xl relative max-sm:w-full md:col-span-3">
							...
							<div className=" flex flex-col justify-center  p-8">
								<div className=" flex justify-center gap-4 flex-row pb-10">
									<a
										href="https://play.google.com/store/apps/details?id=com.lifepadi.app"
										className=" bg-accent py-3 md:px-2 md:rounded-lg flex items-center gap-2 rounded-full px-3"
									>
										<span className=" max-md:flex max-md:item-center max-md:justify-center">
											<img
												src={Playstore}
									...
									<a
										href="https://apps.apple.com/us/app/lifepadi/id6741829265"
										className=" bg-accent   py-3 px-3 rounded-lg flex items-center gap-2 max-md:rounded-full max-md:px-3"
									>
										<span className=" max-md:flex max-md:item-center max-md:justify-center">
											<img
												src={Apple}
								...
								<div className="flex justify-center">
									<Link
										to="/shop/logistics"
										className=" bg-secondary hover:bg-background rounded-xl p-3 px-8 text-accent font-semibold cursor-pointer"
									>
										Use Lifepadi Logistics
									</Link>
								</div>
