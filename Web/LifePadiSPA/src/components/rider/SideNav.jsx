...
const SideNav = ({aside}) => {
  ...
  return (
    <div className={`fixed top-0 left-0 z-40 lg:w-58 h-screen pt-8 pb-10 dark:bg-gray-800 transition-transform  bg-gray-50 border-r border-gray-200 md:translate-x-0  dark:border-gray-700 ${
