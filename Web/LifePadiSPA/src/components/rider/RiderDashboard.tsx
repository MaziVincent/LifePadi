...
const RiderDashboard = () => {
	...
	const estEarnings = useMemo(() => {
		return deliveries
			...
			.reduce(
				(acc: number, d: any) =>
					acc + Number(d?.DeliveryFee ?? d?.deliveryFee ?? 0),
				0,
			);
	}, [deliveries]);
	...
	return (
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
				...
				<StatCard
					label="Successful"
					value={successfulDeliveriesCountQuery.data as number | undefined}
				...
				<StatCard
					label="Pending"
					value={pendingDeliveriesCountQuery.data as number | undefined}
