  ...
  return (
    <main>
        <div className="bg-gray-100 dark:bg-gray-900 h-[100svh] ">
            <div className="flex justify-between bg-gray-50 text-gray-700  border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 fixed left-0 right-0 top-0 z-50 ">
                <ClickAwayListener
                    onClickAway={() => {
                    setAside(false);
                    }}
            ...
            <div className="flex h-screen">
                ...
                <div className={`p-2 pl-5 ml-1 md:ml-20 lg:ml-48 py-20 w-full h-full`}>
                    <Outlet />
                </div>
            </div>
