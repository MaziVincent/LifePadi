...
export const UpdateModal = ({
	...
	const handleUpdateStatus = async () => {
		...
		try {
			...
			queryClient.invalidateQueries(["riderDeliveries"]);
			queryClient.invalidateQueries(["pendingDeliveriesCount"]);
			queryClient.invalidateQueries(["successfulDeliveriesCount"]);
