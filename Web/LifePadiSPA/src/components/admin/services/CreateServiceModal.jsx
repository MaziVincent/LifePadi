...
const CreateServiceModal = ({ open, handleClose }) => {
  ...
  return (
    ...
    >
      ...
      <div
        id="defaultModal"
        className=" overflow-y-auto overflow-x-hidden absolute top-9   md:right-1/4 z-50 justify-center items-center  w-full md:w-2/4   h-modal md:h-auto bg-primary rounded-lg dark:text-primary dark:bg-darkMenu "
      >
        <Toaster />
