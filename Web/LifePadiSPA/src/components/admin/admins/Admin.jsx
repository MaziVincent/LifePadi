...
const Admin = () => {
	...
	const { data, isError, isLoading, isSuccess } = useQuery({
		...
		queryFn: () =>
			getadmins(`${url}/all?PageNumber=${page}&SearchString=${search}`),
	...
	return (
        ...
        /> */}
			...
			<AdminPasswordChange
				open={state.password}
				handleClose={dispatch}
				email={data?.result?.find((a) => a.Id === state.id)?.Email}
									...
									<tbody>
										{data?.result.map((admin) => (
											<tr
												...
												key={admin.Id}
												//onClick={() => navigate(`/admin/admin/${admin.Id}`)}
											>
												<th className="flex gap-3 px-6 py-4 font-normal justify-start text-gray-900">
													...
													<div className="text-sm">
														...
														<div className="text-gray">{admin.Email}</div>
													</div>
												</th>
												...
												<td className="px-3 py-4 ">
													<div className="flex justify-end gap-5 ">
														{admin.IsActive ? (
															<button
																...
																onClick={(event) => {
																	...
																	dispatch({ type: "id", payload: admin.Id });
														...
														<button
															...
															className="bg-background p-2 rounded-xl font-bold hover:bg-secondary">
															Change Password
														</button>
													</div>
												</td>
