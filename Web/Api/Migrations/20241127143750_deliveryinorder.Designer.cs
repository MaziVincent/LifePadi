...
namespace Api.Migrations
{
    ...
    [Migration("20241127143750_deliveryinorder")]
    partial class deliveryinorder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Models.Logistic", b =>
                {
                    ...
                    b.Property<int?>("RecieverAddressId")
                        .HasColumnType("integer");

                    b.Property<int?>("RecieverAddressModelId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("SenderAddressModelId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RecieverAddressModelId");

                    b.HasIndex("SenderAddressModelId");
            ...
            modelBuilder.Entity("Api.Models.Logistic", b =>
                {
                    ...
                    b.HasOne("Api.Models.Address", "RecieverAddressModel")
                        .WithMany()
                        .HasForeignKey("RecieverAddressModelId");

                    b.HasOne("Api.Models.Address", "SenderAddressModel")
                        .WithMany()
                        .HasForeignKey("SenderAddressModelId");

                    b.Navigation("Order");

                    b.Navigation("RecieverAddressModel");

                    b.Navigation("SenderAddressModel");
                });
